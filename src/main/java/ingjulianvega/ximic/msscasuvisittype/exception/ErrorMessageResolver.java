...
import ingjulianvega.ximic.msscasuvisittype.configuration.VisitTypeParameters;
...
public class ErrorMessageResolver {
    ...
    private final VisitTypeParameters visitTypeParameters;
    ...
    public ApiError resolveException(final String key) {
        ...
        return ApiError.builder().code(visitTypeParameters.getPrefix() + errorArr[0]).description(errorArr[1]).build();
    }

    private ApiError getApiGenericError() {
        final String message = "UNKNOWN ERROR";
        return ApiError.builder()
                .code(visitTypeParameters.getPrefix() + "500:199")
                .description(message)
                .build();
    }
}
