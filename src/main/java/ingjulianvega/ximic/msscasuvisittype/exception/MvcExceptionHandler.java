...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(VisitTypeParameters visitTypeParameters) {
        this.visitTypeParameters = visitTypeParameters;
    }

    VisitTypeParameters visitTypeParameters;


    @ExceptionHandler(VisitTypeException.class)
    public ResponseEntity<ApiError> validationErrorHandler(VisitTypeException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(visitTypeParameters.getApi())
